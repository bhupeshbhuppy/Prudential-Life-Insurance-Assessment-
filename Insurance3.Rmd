    ...
    lapply(
      ...
      function(p){
         tags$div(
          ...
          class=ifelse(p==var_kind[1],"tab-pane active","tab-pane"),
          #  id will need to match the id provided to the a href above
          id=paste0("tab-",p),
          train_temp<-train_categ[,grep(p,colnames(train_categ))],
          index<-1,
          plt<-list(),
...
![Fitting XGBoost](D:\bhupesh\Insurance_Code\Dev\input\XGBoost1.png)
...
![Node Creation](D:\bhupesh\Insurance_Code\Dev\input\XGBoost2.jpg)
...
![](D:\bhupesh\Insurance_Code\Dev\input\XGBoost3.jpg)
...
![Score Calculation](D:\bhupesh\Insurance_Code\Dev\input\XGBoost4.jpg)
...
![Optimal Split](D:\bhupesh\Insurance_Code\Dev\input\XGBoost5.jpg)
